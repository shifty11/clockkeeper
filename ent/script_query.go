...
func (_q *ScriptQuery) QueryOwner() *UserQuery {
...
func (_q *ScriptQuery) QueryGames() *GameQuery {
...
func (_q *ScriptQuery) FirstID(ctx context.Context) (id int, err error) {
	var ids []int
...
func (_q *ScriptQuery) FirstIDX(ctx context.Context) int {
...
func (_q *ScriptQuery) OnlyID(ctx context.Context) (id int, err error) {
	var ids []int
...
func (_q *ScriptQuery) OnlyIDX(ctx context.Context) int {
...
func (_q *ScriptQuery) IDs(ctx context.Context) (ids []int, err error) {
...
func (_q *ScriptQuery) IDsX(ctx context.Context) []int {
	ids, err := _q.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (_q *ScriptQuery) WithOwner(opts ...func(*UserQuery)) *ScriptQuery {
	query := (&UserClient{config: _q.config}).Query()
...
func (_q *ScriptQuery) WithGames(opts ...func(*GameQuery)) *ScriptQuery {
	query := (&GameClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (_q *ScriptQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Script, error) {
	...
	if query := _q.withOwner; query != nil {
		if err := _q.loadOwner(ctx, query, nodes, nil,
			func(n *Script, e *User) { n.Edges.Owner = e }); err != nil {
			return nil, err
		}
	}
	if query := _q.withGames; query != nil {
		if err := _q.loadGames(ctx, query, nodes,
			func(n *Script) { n.Edges.Games = []*Game{} },
			func(n *Script, e *Game) { n.Edges.Games = append(n.Edges.Games, e) }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
...
func (_q *ScriptQuery) loadOwner(ctx context.Context, query *UserQuery, nodes []*Script, init func(*Script), assign func(*Script, *User)) error {
...
func (_q *ScriptQuery) loadGames(ctx context.Context, query *GameQuery, nodes []*Script, init func(*Script), assign func(*Script, *Game)) error {
	...
	if len(query.ctx.Fields) > 0 {
		query.ctx.AppendFieldOnce(game.FieldScriptID)
	}
	query.Where(predicate.Game(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(script.GamesColumn), fks...))
	}))
	neighbors, err := query.All(ctx)
	if err != nil {
		return err
	...
	for _, n := range neighbors {
		...
		node, ok := nodeids[fk]
		if !ok {
			return fmt.Errorf(`unexpected referenced foreign-key "script_id" returned %v for node %v`, fk, n.ID)
		}
		assign(node, n)
	}
	return nil
...
func (_q *ScriptQuery) querySpec() *sqlgraph.QuerySpec {
	...
	if fields := _q.ctx.Fields; len(fields) > 0 {
		...
		if _q.withOwner != nil {
			_spec.Node.AddColumnOnce(script.FieldUserID)
		}
	}
